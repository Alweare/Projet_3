...
<html lang="fr">
    ...
    <header>         <!-- En-tête de la page -->
        ...
        <head>
                ...
                <p><img src="images/logo_gbaf.png" alt="Logo GBAF" class="logo_gbaf"/></p> 
        ...
        <body>
            ...
            <section> <!-- section présentation -->
                ...
                <h1>La GBAFF meilleur banque</h1> <!-- à modifier avec le vrai texte -->

                <p><img src=""alt="Bannière gbaf" class="banniere" /></p>
            ...
            <section>
                    ...
                    <h2>acteurs et partenaire</h2> <!-- à modifier avec le vrai texte -->
                        ...
                        <article>
                            ...
                            <a href="" id="bouton_lire_la_suite">Lire la suite</a>
                        </article>
